    ...
    <NavLink
      ...
      className={({ isActive }) =>
        isActive
          ...
          : 'mx-auto w-2/3 min-w-fit rounded-md px-6 py-2 hover:bg-background-color-primary sm:mx-0 sm:w-full sm:rounded-none sm:px-2 sm:py-0 sm:hover:border-b sm:hover:bg-background-color-secondary hover:dark:bg-background-color-primary-dark sm:hover:dark:bg-background-color-secondary-dark'
      }
      to={route}
    >
